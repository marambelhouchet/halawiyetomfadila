...
<header>
    ...
    <div class="i">
        <div class="t">حلويات فضيلة حلويات أصيلة</div>
        <div class="d">Halawiyet Fadhila</div>
    </div>
    <a class="small-button" href="achat.php">&#128722;</a> 
    <div>
        <img src="dou.png"  class="a">
    </div>
    <div>
        <img src="graib - Copie.png"  class="a1">
    </div>
    <div>
        <img src="graib - Copie (2).png"  class="a2">
    </div>
    <div>
        <img src="graib - Copie (3).png"  class="a3">
    </div>
    <div>
        <img src="mak - Copie.png"  class="a4">
    </div>
    <div>
        <img src="sss.png"  class="a5">
    </div>
    <div>
        <img src="yo.jpg"  class="a6">
    </div>
    
    <div>
        <img src="coo.png"  class="a8">
    </div>
    <div><div>
        <img src="mmm.jpg"  class="a7">
    </div>
    <div>
